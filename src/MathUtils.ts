...
export class MathUtils
{
     ...
     */
    static sind(angle : number) : number
    {
     ...
     * @returns {number} The value.
     */
    static cosd(angle : number) : number
    {
     ...
     */
    static asind(val : number) : number
    {
     ...
     */
    static acosd(val : number) : number
    {
     ...
     */
    static atand(val : number) : number
    {
     ...
     */
    static atan2d(y : number, x : number) : number
    {
     ...
     */
    static vecSum(u : number[], v : number[]) : number[]
    {
        return [u[0]+v[0], u[1]+v[1], u[2]+v[2]];
    }
     ...
     */
    static linComb(k : number[], x : number[][]) : number[]
    {
     ...
     */
    static vecDiff(u : number[], v : number[]) : number[]
    {
        return [u[0]-v[0], u[1]-v[1], u[2]-v[2]];
    }
     ...
     */
    static vecMul(u : number[], s : number) : number[]
    {

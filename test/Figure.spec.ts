...
import { Figure, FigureOutput } from '../src/Figure';
...
describe('Figure', function() {
    ...
    it('accOblateness', function() {
        ...
        const output : FigureOutput = Figure.accOblateness(
        ...
        const accSun   = output.accSJ2000;
        const accEarth = output.accEJ2000;
        const accMoon  = output.accMJ2000;
        const libMoon  = output.libration;
